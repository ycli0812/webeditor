...
function VoltageSource(props) {
    ...
    return (
        <g transform={`translate(${pixelX} ${pixelY})`} onMouseDown={handleMouseDown}>
            ...
            <path d="M 162.254 153.873 L 125.367 58.669 L 139.005 58.669 L 163.748 127.831 Q 166.735 136.144 168.748 143.417 Q 170.956 135.624 173.879 127.831 L 199.595 58.669 L 212.454 58.669 L 175.178 153.873 Z" transform="matrix(0.969952, 0, 0, 1, -14.186452, 51.825439)" style="fill: rgb(255, 253, 253); white-space: pre;"/>
